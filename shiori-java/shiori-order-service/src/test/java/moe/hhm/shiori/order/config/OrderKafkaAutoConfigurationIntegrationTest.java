...
class OrderKafkaAutoConfigurationIntegrationTest {
    ...
    void shouldAutoConfigureKafkaBeansNeededByConsumerErrorHandler() {
        ...
        new ApplicationContextRunner()
                ...
                .withUserConfiguration(OrderKafkaConsumerConfiguration.class)
                .withPropertyValues(
                        "order.kafka.enabled=true",
                        "spring.kafka.bootstrap-servers=localhost:9092",
                        "spring.kafka.consumer.group-id=test-order-group",
