...
import java.net.URI;
import moe.hhm.shiori.product.storage.AwsS3PresignClient;
import moe.hhm.shiori.product.storage.OssObjectService;
import moe.hhm.shiori.product.storage.S3CompatibleOssObjectService;
import moe.hhm.shiori.product.storage.S3PresignClient;
