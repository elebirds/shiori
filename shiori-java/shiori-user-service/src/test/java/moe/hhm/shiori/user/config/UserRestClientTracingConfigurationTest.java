...
@SpringBootTest(classes = UserRestClientTracingConfigurationTest.TestConfiguration.class, properties = {
...
class UserRestClientTracingConfigurationTest {
    ...
    static class TestConfiguration extends UserRestClientConfiguration {
    }
}
