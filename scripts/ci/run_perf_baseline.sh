...
K6_ORDER_BUYER_CDK="${K6_ORDER_BUYER_CDK:-}"
K6_ORDER_BUYER_CDKS="${K6_ORDER_BUYER_CDKS:-}"
K6_WS_BUYER_CDK="${K6_WS_BUYER_CDK:-}"
K6_WS_BUYER_CDKS="${K6_WS_BUYER_CDKS:-}"
...
main() {
  ...
  [[ -f "${PERF_DIR}/${K6_ORDER_SCRIPT}" ]] || fail "未找到 ${K6_ORDER_SCRIPT}"
  ...
  log "执行订单链路基线..."
  k6 run "${PERF_DIR}/${K6_ORDER_SCRIPT}" \
    ...
    -e K6_ORDER_BUYER_CDK="${K6_ORDER_BUYER_CDK}" \
    -e K6_ORDER_BUYER_CDKS="${K6_ORDER_BUYER_CDKS}" \
  ...
  k6 run "${PERF_DIR}/k6-ws.js" \
    ...
    -e K6_WS_BUYER_CDK="${K6_WS_BUYER_CDK}" \
    -e K6_WS_BUYER_CDKS="${K6_WS_BUYER_CDKS}" \
