...
export const ACCESS_TOKEN_KEY = 'shiori_admin_access_token'
export const REFRESH_TOKEN_KEY = 'shiori_admin_refresh_token'
...
function shouldRefresh(config: RetryableConfig): boolean {
  ...
  return !url.includes('/api/user/auth/login') && !url.includes('/api/user/auth/refresh')
}
